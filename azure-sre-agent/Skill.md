...
compatibility: Network Access Required. Uses mcp_microsoftdocs:microsoft_docs_fetch or fetch_webpage to retrieve documentation.
metadata:
...
| Topic | URL |
|-------|-----|
| Query Azure SRE Agent telemetry and actions with KQL | https://learn.microsoft1.com/en-us/azure/sre-agent/audit-agent-actions |
...
curl -X POST https://learn.microsoft.com/en-us/azure/sre-agent/deploy-iac